<template>
    <div class="indi-form__input--has-icon">
        <input class="indi-form__input js-object-datepicker" id="datepicker-sinkpage" :value=dateField>
        <div class="indi-form__help-text"> mm/dd/yyyy </div>
        <svg class="indi-icon indi-form__input-icon" aria-labelledby="title">
            <title>calendar</title>
            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="indi_icons.svg#calendar"></use>
        </svg>
        <div class="indi-form__datepicker">
            <div class="indi-form__datepicker-head">
                <a class="indi-form__datepicker-head-previous" href="#" aria-label="Previous Month">
                    <svg class="indi-icon" aria-labelledby="title">
                        ...
                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="./indi_icons.svg#caret-left"> </use>
                    </svg>
                </a>
                ...
                <a class="indi-form__datepicker-head-next" href="#" aria-label="Next Month">
                    <svg class="indi-icon" aria-labelledby="title">
                        ...
                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="./indi_icons.svg#caret-right"> </use>
                    </svg>
                </a>
            </div>
            <table class="indi-form__datepicker-calender">
                ...
                <tr>
                    ...
                    <td>
                        <button aria-label="09/01/2017" class="indi-form__datepicker-next-month-dates">1</button></td>
                    <td>
                        <button aria-label="09/02/2017" class="indi-form__datepicker-next-month-dates">2</button></td>
                </tr>
                </tbody>
            </table>
        </div>
...
<script>
    ...
    export default {
        ...
        props:['value'],
        data: ()=> ({
            dateField: '01/01/2018'
        }),
        created(){
            this.dateField = this.value
        }
